...
export const departements: Departement[] = [
  { number: 1, name: "Ain" },
  { number: 2, name: "Aisne" },
  { number: 3, name: "Allier" },
  { number: 4, name: "Alpes-de-Haute-Provence" },
  { number: 5, name: "Hautes-Alpes" },
  { number: 6, name: "Alpes-Maritimes" },
  { number: 7, name: "Ardèche" },
  { number: 8, name: "Ardennes" },
  { number: 9, name: "Ariège" },
  { number: 10, name: "Aube" },
  { number: 11, name: "Aude" },
